...
5. 靜音分享流程圖  
 ...
 - **首頁（書籍總覽頁）**：使用者登入後的首頁即為書籍總覽頁。使用者可在此頁面中瀏覽系統所提供的書籍，系統依照 ‘book’ 資料表的 ‘category’ 欄位顯示分類區塊（（如：科幻、推理、言情等），並提供搜尋功能。每本書將顯示書名、作者、封面與平均評分，使用者可點選書籍進入詳情頁，或選擇加入書架。此頁面亦可顯示推薦書籍與最近新增的書籍，方便使用者探索閱讀內容。
